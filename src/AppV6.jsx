      ...
      <section className="hero-v6-section">
        <div className="hero-v6-container">
          ...
          <h1 className="hero-v6-title">
            ...
            sua operação<br />
            <span className="highlight-orange">rodasse sozinha?</span>
          </h1>
          <p className="hero-v6-sub">Sábado, 9h, eu te mostro como.</p>
          <span className="cta-stack">
            <a href="#checkout" className="btn-brutalist btn-brutalist-orange">DESCOBRIR — R$ 9</a>
            <CtaProgress />
          </span>
          <p className="hero-v6-footnote">📅 25 de abril · 3 horas ao vivo · Online</p>
        </div>
      </section>
