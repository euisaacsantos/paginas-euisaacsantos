        ...
        <div className="hero-v5-container">
          <div className="hero-v5-text">
            ...
            <h1 className="hero-v5-title">
              E em <span className="highlight-orange">3 horas</span> eu te mostro como.
            </h1>
            <p className="hero-v5-sub">Imersão ao vivo onde você sai com 3 agentes rodando suas campanhas, relatórios e monitoramento — sem programar nada.</p>
            <span className="cta-stack">
              <a href="#checkout" className="btn-brutalist btn-brutalist-orange">QUERO APRENDER — R$ 9</a>
              <CtaProgress />
            </span>
            <p className="hero-v5-footnote">📅 Sábado, 25/04 · 9h às 12h · Online ao vivo</p>
          </div>
