  ...
  return (
    <h1 className="mb-4 md:mb-6 font-black leading-[1.05] tracking-tight hero-title-v1 relative" style={{ whiteSpace: 'pre-line' }}>
      <span aria-hidden="true" className="invisible">
        {'Pare de subir campanha.\nComece a '}<span className="highlight-orange">COMANDAR</span>.
      </span>
...
function AppV3() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* HERO */}
      <section className="hero-section hero-section-v3 relative overflow-hidden">
        <div className="hero-term-abs hidden lg:block">
          <ClaudeTerminal />
        </div>
        <img src="/assets/clawd mascot.webp" alt="" className="clawd-float hidden lg:block" />
        <img src="/assets/clawd mascot.webp" alt="" className="clawd-float clawd-float--2 hidden lg:block" />
        ...
        <div className="max-w-6xl mx-auto px-5">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="reveal tech-card !p-0 overflow-hidden flex flex-col order-1 md:order-2">
              <img src="/assets/isaacbio.webp" alt="Isaac Santos" className="w-full h-full object-cover" />
